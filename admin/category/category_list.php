                        ...
                        <tbody>
                            <?php foreach($category_list as $category) : ?>
                                <tr>
                                    ...
                                    <td><button class="delete" data-id=<?php echo $category['category_id']; ?>>削除</button></td>
                                    <td><button class="cancel" data-id=<?php echo $category['category_id']; ?>>削除キャンセル</button></td>
                                <tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
